...
class TestGetV2User:
    ...
    def test_get_v2_users_by_username_all_fields(
        self,
...
class TestMockGetV2User:
    @pytest.mark.parametrize(
        ...
        [
            ...
            "get_v2_users_by_username_response_body_all_fields.json",
        ],
    )
    def test_mock_get_v2_users_by_username(
        ...
        response_body = GetV2UsersByUsernameResponseBody.model_validate(
