...
GetTweetsQueryParameters = TypedDict(
    "GetTweetsQueryParameters",
    {
...
def _make_query(query: GetTweetsQueryParameters) -> dict:
    return {
...
class GetTweetsResponseBodyIncludes(ExtraPermissiveModel):
    users: list[User]


class GetTweetsResponseBody(ExtraPermissiveModel):
    data: list[Tweet]
    includes: Optional[GetTweetsResponseBodyIncludes] = None
...
class GetTweets:
    ...
    def get(self, query: GetTweetsQueryParameters) -> GetTweetsResponseBody:
        # flake8: noqa E501
        """
        ツイートの一覧を取得する。
        ...
        return self._client.get(
            ...
            response_type=GetTweetsResponseBody,
        )
