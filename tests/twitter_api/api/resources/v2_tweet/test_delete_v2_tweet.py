...
class TestDeleteV2Tweet:
    def test_delete_v2_tweet(self, real_user_auth_v1_client: TwitterApiRealClient):
...
class TestMockDeleteV2Tweet:
    def test_mock_delete_v2_tweet(self, mock_app_auth_v2_client: TwitterApiMockClient):
